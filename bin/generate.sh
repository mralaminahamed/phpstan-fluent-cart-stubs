#!/usr/bin/env bash
#
# Generate Fluent Cart stubs from the source directory.
#
# This script generates type declaration stubs for the Fluent Cart plugin,
...
HEADER=$'/**\n * Generated stub declarations for Fluent Cart.\n * @see https://fluentcart.com/\n * @see https://github.com/mralaminahamed/phpstan-fluent-cart-stubs\n */'
FILE="$ROOT_DIR/fluent-cart-stubs.stub"
FILE_CONSTANTS="$ROOT_DIR/fluent-cart-constants-stubs.stub"
...
[[ -d "$ROOT_DIR/source/fluent-cart" ]] || error_exit "Fluent Cart source not found at $ROOT_DIR/source/fluent-cart"
